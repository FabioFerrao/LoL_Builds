namespace LoL_Builds.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<LoL_Builds.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(LoL_Builds.Models.ApplicationDbContext context)
        {
